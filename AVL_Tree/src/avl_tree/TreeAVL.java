...
class TreeAVL<T extends Comparable<T>> {
    class Node<T> {
        ...
        @Override
        public boolean equals(Object o) {  // для тестов.
    ...
    public boolean add(T t) {   //главный метод добавления (add)
    ...
    public boolean remove(T delKey) {    // главный метод удаления (remove)
